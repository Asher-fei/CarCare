...
public class FragmentCarRefitTpl extends BaseTpl<CarInShopBean.DataBean> {
    ...
    public FragmentCarRefitTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FragmentCarRefitTpl(Context context) {
        super(context);
    }
