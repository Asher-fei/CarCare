...
public class FragmentCarRepairTpl extends BaseTpl<CarInShopBean.DataBean> {
    ...
    public FragmentCarRepairTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FragmentCarRepairTpl(Context context) {
        super(context);
    }
