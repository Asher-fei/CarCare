...
import com.lida.carcare.activity.ActivityScreenInventoryShop;
...
public class ActivityScreenInventoryShopTpl extends BaseTpl<SelectOutboundGoodslistBean.DataBean> {
    ...
    public ActivityScreenInventoryShopTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ActivityScreenInventoryShopTpl(Context context) {
        super(context);
    }
    ...
    protected int getLayoutId() {
        return R.layout.item_screen_inventory_shop;
    }
        ...
        if (bean != null) {
            ...
            llItem.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    String temp = ActivityScreenInventoryShop.tvRight.getText().toString();
                    ...
                    ActivityScreenInventoryShop.tvRight.setText("完成("+i+")");
                    Log.e("wqf",i+"");
                }
            });
        }
