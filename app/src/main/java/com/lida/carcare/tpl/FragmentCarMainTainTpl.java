...
public class FragmentCarMainTainTpl extends BaseTpl<CarInShopBean.DataBean> {
    ...
    public FragmentCarMainTainTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FragmentCarMainTainTpl(Context context) {
        super(context);
    }
    ...
    public void setBean(final CarInShopBean.DataBean bean, int position) {
        if (bean != null) {
                   ...
                   final Bundle bundle = new Bundle();
                    switch (v.getId()) {
                        ...
                        case R.id.btnSettleMent:
                            ...
                            } /*else if ("去派工".equals(btnSettleMent.getText().toString())) {
                                bundle.putString("item", serviceItem);
                                bundle.putString("carNo", bean.getCarNo());
                                bundle.putString("name", bean.getCustomerName());
                                bundle.putString("userId", bean.getId());
            ...
            tvServiceItem.setText(serviceItem);
