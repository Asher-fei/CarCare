...
public class ActivityWillExpireTpl extends BaseTpl<WillExpireBean.DataBean> {
    ...
    public ActivityWillExpireTpl(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ActivityWillExpireTpl(Context context) {
        super(context);
    }
