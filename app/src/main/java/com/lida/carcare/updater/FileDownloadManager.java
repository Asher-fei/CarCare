...
class FileDownloadManager {
    ...
    long startDownload(UpdaterConfig updaterConfig) {
        ...
        int pos = updaterConfig.getFileUrl().lastIndexOf('/');
        String file_name = updaterConfig.getFileUrl().substring(pos, updaterConfig.getFileUrl()
                .length());
        req.setDestinationInExternalFilesDir(updaterConfig.getContext(), Environment.DIRECTORY_DOWNLOADS, file_name);
        //第二种
