...
import com.lida.carcare.tpl.ActivityExpireTpl;
...
public class ActivityExpire extends BaseListActivity {
    ...
    private ActivityExpireData dataSource;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ButterKnife.bind(this);
        topbar.setTitle("已过期详情");
    ...
    protected IDataSource<ArrayList> getDataSource() {
        dataSource = new ActivityExpireData(_activity);
        return dataSource;
    }

    @Override
    protected Class getTemplateClass() {
        return ActivityExpireTpl.class;
    }
}
