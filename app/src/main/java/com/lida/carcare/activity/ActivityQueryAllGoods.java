...
public class ActivityQueryAllGoods extends BaseListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvScreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UIHelper.jumpForResult(_activity, ActivityGoodsManager.class, bundle, ActivityGoodsManager.REQUEST_CODE);
            }
        });
        tvSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                AppUtil.getCarApiClient(ac).selectProductByShopId(tvSearch.getText().toString().trim(), ActivityQueryAllGoods.this);
            }
        });
    }
