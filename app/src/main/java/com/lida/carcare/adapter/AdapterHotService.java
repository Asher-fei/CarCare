...
public class AdapterHotService extends BaseAdapter {

    List<ServerHotBean.DataBean> list;
    Context context;

    public AdapterHotService(List<ServerHotBean.DataBean> list,Context context){
        this.list = list;
    ...
    @Override
    public ServerHotBean.DataBean getItem(int position) {
            ...
            public void onClick(View v) {
                if(list.get(position).getCode().equalsIgnoreCase("A01")) {
                    if (!ActivityAddCar.goodsProject.toString().contains(list.get(position).getName())) {
                        ...
                        ActivityAddCar.serviceEditData.add(new ServiceEditBean(list.get(position).getId(), "goodsProject", list.get(position).getName(), "1", list.get(position).getPrice()));
                    ...
                    if (!ActivityAddCar.maintainProject.toString().contains(list.get(position).getName())) {
                        ...
                        ActivityAddCar.serviceEditData.add(new ServiceEditBean(list.get(position).getId(), "maintainProject", list.get(position).getName(), "1", list.get(position).getPrice()));
                        UIHelper.t(context, list.get(position).getName());
                    } else {
                        UIHelper.t(context, "已添加该项目");
                    }
                    ...
                    if (!ActivityAddCar.repairProject.toString().contains(list.get(position).getName())) {
                        ...
                        ActivityAddCar.serviceEditData.add(new ServiceEditBean(list.get(position).getId(), "repairProject", list.get(position).getName(), "1", list.get(position).getPrice()));
                        UIHelper.t(context, list.get(position).getName());
                    } else {
                        UIHelper.t(context, "已添加该项目");
                    }
                    ...
                    if (!ActivityAddCar.refitProject.toString().contains(list.get(position).getName())) {
                        ...
                        ActivityAddCar.serviceEditData.add(new ServiceEditBean(list.get(position).getId(), "refitProject", list.get(position).getName(), "1", list.get(position).getPrice()));
                        UIHelper.t(context, list.get(position).getName());
                    } else {
                        UIHelper.t(context, "已添加该项目");
                    }
