...
public class AdapterGoodsClass extends BaseExpandableListAdapter
{
    ...
    public AdapterGoodsClass(Activity context, ExpandableListView listView, List<GoodClassABean.DataBean> parent, Map<String, List<GoodClassABean.DataBean>> data)
    {
