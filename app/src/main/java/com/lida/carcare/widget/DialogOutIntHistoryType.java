...
public class DialogOutIntHistoryType extends Dialog {
    ...
    /**
     * 0：采购入库，1：其他入库，2：其他出库
     */
    private String[] sArr = {"采购入库","其他入库","其他出库","采购退货","全部"};
    private List<String> data = Arrays.asList(sArr);
    private onItemClickListener listener;

    public DialogOutIntHistoryType(Context context, TextView textView) {
        super(context, R.style.diy_dialog);
        this.textView = textView;
        init(context);
    }

    public DialogOutIntHistoryType(Context context, int themeResId) {
        super(context, R.style.diy_dialog);
        init(context);
    }
