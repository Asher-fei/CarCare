...
public class DialogScreenInventory extends Dialog {
    @BindView(R.id.listView)
    InnerListView listView;

    private Context context;
    private TextView textView;
    private String[] sArr = {"全部","盘盈","盘亏"};
    private List<String> data = Arrays.asList(sArr);
    private onItemClickListener listener;

    public DialogScreenInventory(Context context, TextView textView) {
        super(context, R.style.diy_dialog);
        this.textView = textView;
        init(context);
    }

    public DialogScreenInventory(Context context, int themeResId) {
        super(context, R.style.diy_dialog);
        init(context);
    }
