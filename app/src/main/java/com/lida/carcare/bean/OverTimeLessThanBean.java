...
public class OverTimeLessThanBean extends NetResult {
    ...
    public static OverTimeLessThanBean parse(String json) throws AppException {
        OverTimeLessThanBean res = new OverTimeLessThanBean();
        try{
            res = gson.fromJson(json, OverTimeLessThanBean.class);
