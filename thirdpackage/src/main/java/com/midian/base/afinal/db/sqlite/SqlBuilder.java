...
import com.midian.base.afinal.db.table.Id;
import com.midian.base.afinal.db.table.KeyValue;
...
public class SqlBuilder {
	...
	public static SqlInfo buildDeleteSql(Object entity){
		...
		if(idvalue == null ){
			throw new DbException("getDeleteSQL:"+entity.getClass()+" userId value is null");
		}
	...
	public static SqlInfo getUpdateSqlAsSqlInfo(Object entity){
		...
		if(null == idvalue ) {//主键值不能为null，否则不能更新
			throw new DbException("this entity["+entity.getClass()+"]'s userId value is null");
		}
	 ...
	 * @param key
	 * @param value
	 * @return eg1: name='afinal'  eg2: userId=100
	 */
