...
import com.midian.base.afinal.utils.ClassUtils;
import com.midian.base.afinal.utils.FieldUtils;
	...
	public static  TableInfo get(Class<?> clazz){
		...
		if( tableInfo == null ){
			...
			if(idField != null){
				...
				throw new DbException("the class["+clazz+"]'s idField is null , \n you can define _id,userId property or use annotation @userId to solution this exception");
			}
